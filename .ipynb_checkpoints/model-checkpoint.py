    ...
    def wrangle_data(self, n_observations):
        ...
        if self.use_new_data:
            ...
            self.repo.insert_table(
                table_name=self.from_currency, records=new_data, if_exists='replace'
        ...
        df =self.repo.read_table(table_name=self.from_currency+self.to_currency, limit=n_observations+1)
